...
INSERT INTO transacao (valor, data, parcela, data_pagamento, data_vencimento, fatura_id) VALUES (40.00, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 20 DAY), 1, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 60 DAY), 1);
INSERT INTO transacao (valor, data, parcela, data_pagamento, data_vencimento, fatura_id) VALUES (20.00, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 33 DAY), 1, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 60 DAY), 2);
INSERT INTO transacao (valor, data, parcela, data_pagamento, data_vencimento, fatura_id) VALUES (10.00, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 100 DAY), 1, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 60 DAY), 3);

INSERT INTO transacao (valor, data, parcela, data_pagamento, data_vencimento, fatura_id) VALUES (40.00, CURRENT_TIMESTAMP, 1, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 45 DAY), 1);
